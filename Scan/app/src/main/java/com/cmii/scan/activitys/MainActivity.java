package com.cmii.scan.activitys;
...
import com.cmii.scan.R;
import com.cmii.scan.model.ElecCheckModel;
import com.cmii.scan.utils.ExcelUtils;
import com.cmii.scan.utils.ShareUtils;
        ...
        try {
            if (Build.VERSION.SDK_INT > 23) {
                ...
                int permission = ActivityCompat.checkSelfPermission(MainActivity.this,
                        "android.permission.WRITE_EXTERNAL_STORAGE");
                System.out.println("当前权限为" + permission);
                if (permission != PackageManager.PERMISSION_GRANTED) {
                    // 没有写的权限，去申请写的权限，会弹出对话框
                    ActivityCompat.requestPermissions(MainActivity.this, PERMISSIONS_STORAGE, REQUEST_EXTERNAL_STORAGE);
                }
                System.out.println("申请权限后" + permission);
            }
            ...
            e.printStackTrace();
            Toast.makeText(this, "导出分享失败", Toast.LENGTH_SHORT).show();
        }
    }
